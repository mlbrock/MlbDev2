...
// ////////////////////////////////////////////////////////////////////////////
/*
   File Name         :  ToStreamErrno.cpp

   File Description  :  Logic for streaming errno-related exceptions text.
...
#include <Utility/ToStreamErrno.hpp>
...
// ////////////////////////////////////////////////////////////////////////////
std::ostream &ToStreamErrno(std::ostream &o_str,
...
// ////////////////////////////////////////////////////////////////////////////
std::ostream &ToStreamErrno(std::ostream &o_str, int err_code,
	const char *err_text, bool with_message)
{
	return(ToStreamErrno(o_str,
