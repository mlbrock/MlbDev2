...
// ////////////////////////////////////////////////////////////////////////////
/*
   File Name         :  ParseNumericString.hpp
   ...
   Revision History  :  2008-11-14 --- Creation.
                           Michael L. Brock
                        2023-01-20 --- Migration to C++ MlbDev2/Utility.
                           Michael L. Brock

      Copyright Michael L. Brock 2008 - 2023.
...
template <bool IsInteger, bool IsSigned> struct NumericTypeSpec {
	...
	{
		if (base != 10)
			throw std::invalid_argument("Only base 10 is supported for the "
